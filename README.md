...
Aphelios
是一款为文学创作者量身定制的桌面端编辑器，追求极致的视觉体验与专注的创作环境。它融合了现代Web
技术的灵活性与本地应用的强大性能。

## ✨ 特性

- **🍎
  现代美学**：深度定制的磨砂玻璃（Glassmorphism）效果，温润的圆角设计，每一个细节都经过视觉推敲。
- **🧘 沉浸创作**：一键开启全屏沉浸模式，隐藏所有杂讯，让世界只剩下你和文字。
- **📁
  本地优先**：基于本地文件夹的扁平化文件管理系统，支持标准Markdown格式，数据永远掌握在你自己手中。
- **🌓
  主题模式**：精心调教的浅色（奶油温润）与深色（咖啡炭黑）主题，全天候保护视力，拒绝光污染。
